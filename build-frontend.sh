...
REACT_APP_API_URL=${REACT_APP_API_URL:-https://bandsync-production.up.railway.app}
REACT_APP_GOOGLE_MAPS_API_KEY=${REACT_APP_GOOGLE_MAPS_API_KEY:-}
EOF

echo "📝 Created frontend/.env.production.local with:"
echo "REACT_APP_API_URL=${REACT_APP_API_URL:-https://bandsync-production.up.railway.app}"
