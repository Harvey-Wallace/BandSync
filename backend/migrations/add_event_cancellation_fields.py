#!/usr/bin/env python3
"""
Add event cancellation fields migration
"""
...
def add_event_cancellation_fields():
    """Add event cancellation fields to the Event table"""
    app = create_app()
    
    with app.app_context():
        try:
            print("🔄 Adding event cancellation fields...")
            ...
            result = db.session.execute(text("""
                ...
                AND column_name IN ('is_cancelled', 'cancelled_at', 'cancelled_by', 'cancellation_reason', 'cancellation_notification_sent')
            """))
            ...
            if "cancelled_by" not in existing_fields:
                try:
                    ...
                    db.session.execute(text("""
                        ALTER TABLE event 
                        ADD CONSTRAINT fk_event_cancelled_by 
